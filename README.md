...
> Want farmers to be able to search from their own phones with the data already
> included? Ask for the **"baked-in"** version instead: you send the two CSVs and they
> get embedded into the app file itself.
